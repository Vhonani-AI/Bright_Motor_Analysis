...
The objective is to extract actionable insights from historical car sales data to help the newly appointed Head of Sales expand the dealership network, improve sales performance, and optimise inventory. The analysis examines revenue generation, brand performance, geographic distribution, and profitability trends to support data-driven decision-making.
...
While 2015 saw a significant surge in activity, particularly in January, the platform faces a major gap in pricing strategy, with nearly half of all vehicles selling below their market potential. This is largely due to a high volume of high-mileage inventory and a lack of focus on revenue efficiency.
...
This project demonstrates how raw transactional car sales data can be transformed into meaningful insights that support high-level business decision-making. It highlights my ability to work through the full data analysis process, from planning and data preparation to deep analysis and executive presentation.
